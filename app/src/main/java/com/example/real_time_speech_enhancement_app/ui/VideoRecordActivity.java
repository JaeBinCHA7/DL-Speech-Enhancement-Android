...
public class VideoRecordActivity extends AppCompatActivity {
    ...
    /**
     * An {@link com.example.real_time_speech_enhancement_app.ui.AutoFitTextureView} for camera preview.
     */
    private com.example.real_time_speech_enhancement_app.ui.AutoFitTextureView mTextureView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = (com.example.real_time_speech_enhancement_app.ui.AutoFitTextureView) findViewById(R.id.texture);
        mButtonVideo = (Button) findViewById(R.id.btn_video_record);
...
//        String recordPath = getActivity().getExternalFilesDir("/").getAbsolutePath(); // /storage/emulated/0/Android/data/com.example.yonsei_isp_se/files
        ...
        String videoFileName = recordPath + "/" + "VideoFile" + timeStamp + "_" + "video.mp4";

//        String fileName = String.format("%d.mp4", System.currentTimeMillis()); //1663482376035.mp4
        mNextVideo = new File(recordPath, videoFileName);
