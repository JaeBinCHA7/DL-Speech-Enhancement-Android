...
public class AudioAdapter extends RecyclerView.Adapter {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            audioBtn = itemView.findViewById(R.id.btn_record_play);
            audioTitle = itemView.findViewById(R.id.btn_record_play_text);
            audioDownload = itemView.findViewById(R.id.btn_download);
            audioSE = itemView.findViewById(R.id.btn_se);

            // 클릭한 버튼에 따라 클릭한 버튼이 Fragment, audioAdapter view로 전달됨.
            ...
            audioSE.setOnClickListener(new Button.OnClickListener() {
                @Override
                public void onClick(View view) {
                    //3. 아이템 클릭 이벤트 핸들러 메스드에서 리스너 객체 메서드 호출
                    int pos = getAdapterPosition();
            ...
            audioDownload.setOnClickListener(new Button.OnClickListener() {
                @Override
                public void onClick(View view) {
                    //3. 아이템 클릭 이벤트 핸들러 메스드에서 리스너 객체 메서드 호출
                    int pos = getAdapterPosition();
